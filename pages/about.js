    ...
    <>
      ...
      <StyledAbout>
        <div className="about-header">
          <strong>
            Hudson River Companies is a real estate acquisition and investment
            firm focused on risk adjusted opportunistic strategy.
          </strong>
        </div>
        ...
        <div className="about-body">
          ...
          <div className={`about-content ${inter.className}`}>
            ...
            <p>
              Saral Gupta founded Hudson River Companies in 2018 to take an
              entrepreneurial and creative approach to opportunistic real estate
              acquisitions and investing. Prior to founding HRC, Saral worked at
              General Motors asset Management, in the alternative investments
              group and at BNY Mellon as an AVP. Saral has an undergraduate
              degree in Finance from Rutgers Business School and a M.S. in Real
              Estate Development & Finance from New York University.
            </p>
          </div>
        </div>
      </StyledAbout>
